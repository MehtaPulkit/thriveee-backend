...
export class CustomersService {
    ...
    try {
      ...
      const customer = queryRunner.manager.create(Customer, {
        ...
        marketing_communications_enabled:
          dto.marketing_communications_enabled ?? false,
      });
  ...
  async update(id: string, dto: UpdateCustomerDto): Promise<Customer> {
    ...
    try {
      ...
      if (dto.email_notifications_enabled !== undefined)
        customer.email_notifications_enabled = dto.email_notifications_enabled;
      if (dto.sms_notifications_enabled !== undefined)
        customer.sms_notifications_enabled = dto.sms_notifications_enabled;
      if (dto.marketing_communications_enabled !== undefined)
        customer.marketing_communications_enabled =
          dto.marketing_communications_enabled;
